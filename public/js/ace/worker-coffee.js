...
define("ace/lib/es5-shim", ["require", "exports", "module"], function (
  ...
  if (!Function.prototype.bind) {
    Function.prototype.bind = function bind(that) {
      // .length is 1
      var target = this;
      if (typeof target != "function") throw new TypeError(); // TODO message
  ...
  if (!Array.prototype.reduce) {
    Array.prototype.reduce = function reduce(fun /*, initial*/) {
      ...
      if (!length && arguments.length == 1) throw new TypeError(); // TODO message
      ...
      if (arguments.length >= 2) {
        ...
        do {
          ...
          if (++i >= length) throw new TypeError(); // TODO message
        } while (true);
      }
    ...
    Array.prototype.reduceRight = function reduceRight(fun /*, initial*/) {
      ...
      if (arguments.length >= 2) {
        ...
        do {
          ...
          if (--i < 0) throw new TypeError(); // TODO message
        } while (true);
      }
  ...
  if (!Date.prototype.toJSON) {
    Date.prototype.toJSON = function toJSON(key) {
      if (typeof this.toISOString != "function") throw new TypeError(); // TODO message
...
define("ace/lib/event_emitter", ["require", "exports", "module"], function (
  ...
  EventEmitter.setDefaultHandler = function (eventName, callback) {
    ...
    if (this._defaultHandlers[eventName])
      throw new Error(
        "The default handler for '" + eventName + "' is already set"
      );
  ...
  EventEmitter.removeListener = EventEmitter.removeEventListener = function (
    eventName,
    callback
  ) {
    this._eventRegistry = this._eventRegistry || {};
...
define("ace/worker/mirror", [
  ...
  var Mirror = (exports.Mirror = function (sender) {
    ...
    var deferredUpdate = (this.deferredUpdate = lang.deferredCall(
...
define("ace/document", [
  ...
  (function () {
    ...
    this.insert = function (position, text) {
      ...
      var lastLine =
        lines.length == 0 ? null : lines.splice(lines.length - 1, 1)[0];
    ...
    this.removeInLine = function (row, startColumn, endColumn) {
      ...
      var newLine =
        line.substring(0, startColumn) + line.substring(endColumn, line.length);
      ...
      if (delta.action === "insertText") {
        ...
        if (range.start.row == row && range.start.column < column) {
          ...
          if (range.end.row == row) {
            column =
              Math.max(0, column - range.end.column) + range.start.column;
          }
          row -= range.end.row - range.start.row;
...
define("ace/mode/coffee/lexer", [
  ...
  (_ref = require("./rewriter")),
    ...
    (INVERSES = _ref.INVERSES);

  (_ref1 = require("./helpers")),
    (count = _ref1.count),
    (starts = _ref1.starts),
    (compact = _ref1.compact),
    (last = _ref1.last);
  ...
  exports.Lexer = Lexer = (function () {
    ...
    Lexer.prototype.identifierToken = function () {
      ...
      if (
        ...
        if (
          tag === "WHEN" &&
          ((_ref3 = this.tag()), __indexOf.call(LINE_BREAK, _ref3) >= 0)
        ) {
          tag = "LEADING_WHEN";
        } else if (tag === "FOR") {
          this.seenFor = true;
    ...
    Lexer.prototype.numberToken = function () {
      ...
      if (/^0[BOX]/.test(number)) {
        ...
        this.error(
          "decimal literal '" + number + "' must not be prefixed with '0'"
        );
    ...
    Lexer.prototype.jsToken = function () {
      var match, script;
      if (
        !(this.chunk.charAt(0) === "`" && (match = JSTOKEN.exec(this.chunk)))
      ) {
        return 0;
      }
    ...
    Lexer.prototype.regexToken = function () {
      ...
      if (
        prev &&
        ((_ref2 = prev[0]),
        __indexOf.call(prev.spaced ? NOT_REGEX : NOT_SPACED_REGEX, _ref2) >= 0)
      ) {
        return 0;
      }
    ...
    Lexer.prototype.literalToken = function () {
      ...
      if (value === "=" && prev) {
        if (
          !prev[1].reserved &&
          ((_ref2 = prev[1]), __indexOf.call(JS_FORBIDDEN, _ref2) >= 0)
        ) {
      ...
      if (value === ";") {
        ...
        __indexOf.call(LOGIC, value) >= 0 ||
        (value === "?" && (prev != null ? prev.spaced : void 0))
      ) {
        tag = "LOGIC";
    ...
    Lexer.prototype.balancedString = function (str, end) {
      ...
      for (
        ...
        if (end === "}" && (letter === '"' || letter === "'")) {
          ...
          letter === "/" &&
          (match = HEREGEX.exec(str.slice(i)) || REGEX.exec(str.slice(i)))
        ) {
    ...
    Lexer.prototype.interpolateString = function (str, options) {
      ...
      while ((letter = str.charAt((i += 1)))) {
        ...
        if (inner.length) {
          ...
          nested.pop();
          if (
            ((_ref2 = nested[0]) != null ? _ref2[0] : void 0) === "TERMINATOR"
          ) {
            nested.shift();
          }
    ...
    Lexer.prototype.tag = function (index, tag) {
      var tok;
      return (
        (tok = last(this.tokens, index)) && (tag ? (tok[0] = tag) : tok[0])
      );
    };
    ...
    Lexer.prototype.value = function (index, val) {
      var tok;
      return (
        (tok = last(this.tokens, index)) && (val ? (tok[1] = val) : tok[1])
      );
    };
  ...
  exports.RESERVED = RESERVED.concat(JS_KEYWORDS)
    .concat(COFFEE_KEYWORDS)
    .concat(STRICT_PROSCRIBED);
...
define("ace/mode/coffee/rewriter", ["require", "exports", "module"], function (
  require,
  exports,
  module
) {
  ...
  exports.Rewriter = (function () {
    ...
    Rewriter.prototype.detectEnd = function (i, condition, action) {
      ...
      while ((token = tokens[i])) {
        ...
        if (((_ref = token[0]), __indexOf.call(EXPRESSION_START, _ref) >= 0)) {
          ...
          ((_ref1 = token[0]), __indexOf.call(EXPRESSION_END, _ref1) >= 0)
        ) {
          levels -= 1;
        }
        i += 1;
    ...
    Rewriter.prototype.addImplicitBraces = function () {
      ...
      condition = function (token, i) {
        ...
        (_ref = this.tokens.slice(i + 1, +(i + 3) + 1 || 9e9)),
          (one = _ref[0]),
          (two = _ref[1]),
          (three = _ref[2]);
        ...
        return (
          ((tag === "TERMINATOR" ||
            ...
            (__indexOf.call(IMPLICIT_END, tag) >= 0 &&
              sameLine &&
              !(i - startIndex === 1))) &&
            ((!startsLine && this.tag(i - 1) !== ",") ||
              !(
                (two != null ? two[0] : void 0) === ":" ||
                ((one != null ? one[0] : void 0) === "@" &&
                  (three != null ? three[0] : void 0) === ":")
              ))) ||
          (tag === "," &&
            one &&
            (_ref1 = one[0]) !== "IDENTIFIER" &&
            _ref1 !== "NUMBER" &&
            _ref1 !== "STRING" &&
            _ref1 !== "@" &&
            _ref1 !== "TERMINATOR" &&
      ...
      return this.scanTokens(function (token, i, tokens) {
        ...
        if (
          ((_ref = tag = token[0]), __indexOf.call(EXPRESSION_START, _ref) >= 0)
        ) {
          stack.push([
        ...
        if (
          !(
            tag === ":" &&
            ((ago = this.tag(i - 2)) === ":" ||
              ((_ref1 = stack[stack.length - 1]) != null
                ? _ref1[0]
                : void 0) !== "{")
          )
        ) {
    ...
    Rewriter.prototype.addImplicitParentheses = function () {
      ...
      condition = function (token, i) {
        ...
        return (
          ...
          this.tag(i - 1) !== "," &&
          (__indexOf.call(IMPLICIT_END, tag) >= 0 ||
            (tag === "INDENT" && !seenControl)) &&
          (tag !== "INDENT" ||
            ((_ref = this.tag(i - 2)) !== "CLASS" &&
              _ref !== "EXTENDS" &&
              ((_ref1 = this.tag(i - 1)),
              __indexOf.call(IMPLICIT_BLOCK, _ref1) < 0) &&
              !(
      ...
      action = function (token, i) {
        return this.tokens.splice(
          i,
          0,
          this.generate("CALL_END", ")", token[2])
        );
      };
      return this.scanTokens(function (token, i, tokens) {
        ...
        (_ref = tokens.slice(i - 1, +(i + 1) + 1 || 9e9)),
          (prev = _ref[0]),
          (current = _ref[1]),
          (next = _ref[2]);
        callObject =
    ...
    Rewriter.prototype.addImplicitIndentation = function () {
      ...
      condition = function (token, i) {
        ...
        return (
          token[1] !== ";" &&
          ((_ref = token[0]), __indexOf.call(SINGLE_CLOSERS, _ref) >= 0) &&
          !(token[0] === "ELSE" && starter !== "IF" && starter !== "THEN")
        );
      };
      action = function (token, i) {
        return this.tokens.splice(
      ...
      return this.scanTokens(function (token, i, tokens) {
        ...
        if (
          ...
          starter = tag;
          (_ref1 = this.indentation(token, true)),
            (indent = _ref1[0]),
            (outdent = _ref1[1]);
          if (starter === "THEN") {
...
define("ace/mode/coffee/helpers", ["require", "exports", "module"], function (
  require,
  exports,
  module
) {
  ...
  exports.some =
    (_ref = Array.prototype.some) != null
      ? _ref
      : function (fn) {
          var e, _i, _len;
...
define("ace/mode/coffee/parser", ["require", "exports", "module"], function (
  require,
  exports,
  module
) {
  var parser = {
    ...
    performAction: function anonymous(
      ...
      switch (yystate) {
        ...
        case 82:
          this.$ = [
            new yy.Access(new yy.Literal("prototype")),
            new yy.Access($$[$0]),
          ];
          break;
        case 83:
        ...
        case 104:
          ...
          break;
        case 105:
          this.$ = new yy.Call("super", [
            new yy.Splat(new yy.Literal("arguments")),
          ]);
          break;
        case 106:
        ...
        case 148:
          ...
          break;
        case 149:
          this.$ = new yy.While(new yy.Literal("true")).addBody(
            yy.Block.wrap([$$[$0]])
          );
          break;
        case 150:
...
define("ace/mode/coffee/nodes", [
  ...
  (_ref = require("./lexer")),
    ...
    (STRICT_PROSCRIBED = _ref.STRICT_PROSCRIBED);

  (_ref1 = require("./helpers")),
    (compact = _ref1.compact),
    (flatten = _ref1.flatten),
    (extend = _ref1.extend),
    (merge = _ref1.merge),
    (del = _ref1.del),
    (starts = _ref1.starts),
  ...
  exports.Base = Base = (function () {
    ...
    Base.prototype.compileLoopReference = function (o, name) {
      ...
      if (
        !(
          (-Infinity < +src && +src < Infinity) ||
          (IDENTIFIER.test(src) && o.scope.check(src, true))
        )
      ) {
  ...
  exports.Literal = Literal = (function (_super) {
    ...
    Literal.prototype.jumps = function (o) {
      if (
        this.value === "break" &&
        !((o != null ? o.loop : void 0) || (o != null ? o.block : void 0))
      ) {
        return this;
      }
    ...
    Literal.prototype.compileNode = function (o) {
      ...
      code =
        this.value === "this"
          ? ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0)
    ...
    Return.prototype.compileNode = function (o) {
      return (
        ...
        ("return" +
          [
            this.expression
              ? " " + this.expression.compile(o, LEVEL_PAREN)
              : void 0,
          ] +
          ";")
      );
  ...
  exports.Value = Value = (function (_super) {
    ...
    Value.prototype.isObject = function (onlyGenerated) {
      ...
      return (
        this.base instanceof Obj && (!onlyGenerated || this.base.generated)
      );
    };
    ...
    Value.prototype.compileNode = function (o) {
      ...
      if (
        (this.base instanceof Parens || props.length) &&
        SIMPLENUM.test(code)
      ) {
        code = "" + code + ".";
      }
  ...
  exports.Call = Call = (function (_super) {
    ...
    Call.prototype.newInstance = function () {
      var base, _ref2;
      base =
        ((_ref2 = this.variable) != null ? _ref2.base : void 0) ||
        this.variable;
    ...
    Call.prototype.filterImplicitObjects = function (list) {
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        if (
          !(
            (typeof node.isObject === "function" ? node.isObject() : void 0) &&
            node.base.generated
          )
        ) {
          nodes.push(node);
    ...
    Call.prototype.compileNode = function (o) {
      ...
      if (this.isSuper) {
        return (
          ...
          (".call(" + this.superThis(o) + (args && ", " + args) + ")")
        );
      } else {
        return (
          (this.isNew ? "new " : "") +
  ...
  exports.Range = Range = (function (_super) {
    ...
    Range.prototype.compileVariables = function (o) {
      ...
      (_ref2 = this.from.cache(o, LEVEL_LIST)),
        (this.fromC = _ref2[0]),
        (this.fromVar = _ref2[1]);
      (_ref3 = this.to.cache(o, LEVEL_LIST)),
        (this.toC = _ref3[0]),
        (this.toVar = _ref3[1]);
      if ((step = del(o, "step"))) {
        (_ref4 = step.cache(o, LEVEL_LIST)),
          (this.step = _ref4[0]),
          (this.stepVar = _ref4[1]);
      }
      (_ref5 = [this.fromVar.match(SIMPLENUM), this.toVar.match(SIMPLENUM)]),
        (this.fromNum = _ref5[0]),
        (this.toNum = _ref5[1]);
      if (this.stepVar) {
    ...
    Range.prototype.compileNode = function (o) {
      ...
      (_ref2 = ["" + idx + " <" + this.equals, "" + idx + " >" + this.equals]),
        (lt = _ref2[0]),
        (gt = _ref2[1]);
    ...
    Range.prototype.compileArray = function (o) {
      ...
      if (
        ...
        range = function () {
          _results = [];
          for (
            var _i = (_ref2 = +this.fromNum), _ref3 = +this.toNum;
            _ref2 <= _ref3 ? _i <= _ref3 : _i >= _ref3;
            _ref2 <= _ref3 ? _i++ : _i--
          ) {
            _results.push(_i);
          }
      ...
      hasArgs = function (node) {
        return node != null
          ? node.contains(function (n) {
              return (
                n instanceof Literal && n.value === "arguments" && !n.asKey
              );
            })
          : void 0;
      };
  ...
  exports.Class = Class = (function (_super) {
    ...
    Class.prototype.determineName = function () {
      ...
      decl = (tail = last(this.variable.properties))
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === "constructor") {
              ...
              if (assign.variable["this"]) {
                ...
                assign.variable = new Value(new Literal(name), [
    ...
    Class.prototype.hoistDirectivePrologue = function () {
      ...
      while (
        ((node = expressions[index]) && node instanceof Comment) ||
        (node instanceof Value && node.isString())
      ) {
        ++index;
      }
    ...
    Class.prototype.ensureConstructor = function (name) {
      if (!this.ctor) {
        ...
        if (this.externalCtor) {
          this.ctor.body.push(
            new Literal("" + this.externalCtor + ".apply(this, arguments)")
          );
        }
  ...
  exports.Assign = Assign = (function (_super) {
    ...
    function Assign(variable, value, context, options) {
      ...
      forbidden =
        ((_ref2 = name = this.variable.unwrapAll().value),
        __indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0);
    ...
    Assign.prototype.isStatement = function (o) {
      return (
        ...
        this.context != null &&
        __indexOf.call(this.context, "?") >= 0
      );
    };

    Assign.prototype.assigns = function (name) {
      return this[this.context === "object" ? "value" : "variable"].assigns(
        name
      );
    };
    ...
    Assign.prototype.compileNode = function (o) {
      ...
      if (!this.context) {
        ...
        if (
          !(typeof varBase.hasProperties === "function"
            ? varBase.hasProperties()
            : void 0)
        ) {
          if (this.param) {
      ...
      if (this.value instanceof Code && (match = METHOD_DEF.exec(name))) {
        ...
        this.value.name =
          (_ref3 =
            (_ref4 = (_ref5 = match[2]) != null ? _ref5 : match[3]) != null
              ? _ref4
              : match[4]) != null
            ? _ref3
            : match[5];
    ...
    Assign.prototype.compilePatternMatch = function (o) {
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        if (obj instanceof Assign) {
          (_ref2 = obj),
            ((_ref3 = _ref2.variable), (idx = _ref3.base)),
            (obj = _ref2.value);
        } else {
        ...
        if (
          ((_ref5 = obj.unwrap().value), __indexOf.call(RESERVED, _ref5) >= 0)
        ) {
      ...
      for (i = _i = 0, _len = objects.length; _i < _len; i = ++_i) {
        ...
        if (isObject) {
          if (obj instanceof Assign) {
            (_ref6 = obj),
              ((_ref7 = _ref6.variable), (idx = _ref7.base)),
              (obj = _ref6.value);
          } else {
            if (obj.base instanceof Parens) {
              (_ref8 = new Value(obj.unwrapAll()).cacheReference(o)),
                (obj = _ref8[0]),
                (idx = _ref8[1]);
            } else {
    ...
    Assign.prototype.compileConditional = function (o) {
      ...
      if (
        ...
        left.base instanceof Literal &&
        left.base.value !== "this" &&
        !o.scope.check(left.base.value)
      ) {
        throw new Error(
          'the variable "' +
            left.base.value +
    ...
    Assign.prototype.compileSplice = function (o) {
      var code,
        ...
        _ref3,
        _ref4;
      (_ref2 = this.variable.properties.pop().range),
        (from = _ref2.from),
        (to = _ref2.to),
        (exclusive = _ref2.exclusive);
      name = this.variable.compile(o);
      (_ref3 = (from != null ? from.cache(o, LEVEL_OP) : void 0) || ["0", "0"]),
        (fromDecl = _ref3[0]),
        (fromRef = _ref3[1]);
      if (to) {
        if (
          (from != null ? from.isSimpleNumber() : void 0) &&
          to.isSimpleNumber()
        ) {
      ...
      (_ref4 = this.value.cache(o, LEVEL_LIST)),
        (valDef = _ref4[0]),
        (valRef = _ref4[1]);
      code =
        "[].splice.apply(" +
    ...
    Code.prototype.compileNode = function (o) {
      ...
      for (_l = 0, _len3 = _ref5.length; _l < _len3; _l++) {
        ...
        if (param.isComplex()) {
          ...
          exprs.push(
            new Assign(new Value(param.name), val, "=", {
              param: true,
            })
          );
        } else {
  ...
  exports.Param = Param = (function (_super) {
    ...
    function Param(name, value, splat) {
      ...
      this.splat = splat;
      if (
        ((_ref2 = name = this.name.unwrapAll().value),
        __indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0)
      ) {
        ...
        if (this.guard) {
          if (body.expressions.length > 1) {
            body.expressions.unshift(
              new If(new Parens(this.guard).invert(), new Literal("continue"))
            );
          } else {
            if (this.guard) {
  ...
  exports.Op = Op = (function (_super) {
    ...
    Op.prototype.invert = function () {
      ...
      if (this.isChainable() && this.first.isChainable()) {
        ...
        this.operator === "!" &&
        (fst = this.first.unwrap()) instanceof Op &&
        ((_ref2 = fst.operator) === "!" ||
          _ref2 === "in" ||
          _ref2 === "instanceof")
      ) {
    ...
    Op.prototype.generateDo = function (exp) {
      ...
      passedParams = [];
      func =
        exp instanceof Assign && (ref = exp.value.unwrap()) instanceof Code
          ? ref
          : exp;
      _ref2 = func.params || [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
    ...
    Op.prototype.compileNode = function (o) {
      ...
      if (
        ...
        o.scope.check(this.first.unwrapAll().value)
      ) {
        throw SyntaxError("delete operand may not be argument or var");
      }
      if (
        ((_ref2 = this.operator) === "--" || _ref2 === "++") &&
        ((_ref3 = this.first.unwrapAll().value),
        __indexOf.call(STRICT_PROSCRIBED, _ref3) >= 0)
      ) {
        throw SyntaxError(
    ...
    Op.prototype.compileUnary = function (o) {
      ...
      if (
        ...
        op === "typeof" ||
        op === "delete" ||
        (plusMinus && this.first instanceof Op && this.first.operator === op)
      ) {
        parts.push(" ");
      }
      if (
        (plusMinus && this.first instanceof Op) ||
        (op === "new" && this.first.isStatement(o))
      ) {
  ...
  exports.In = In = (function (_super) {
    ...
    In.prototype.compileLoopTest = function (o) {
      ...
      code =
        utility("indexOf") +
        (".call(" + this.array.compile(o, LEVEL_LIST) + ", " + ref + ") ") +
        (this.negated ? "< 0" : ">= 0");
      if (sub === ref) {
        return code;
      }
  ...
  exports.Try = Try = (function (_super) {
    ...
    Try.prototype.jumps = function (o) {
      var _ref2;
      return (
        this.attempt.jumps(o) ||
        ((_ref2 = this.recovery) != null ? _ref2.jumps(o) : void 0)
      );
    };
  ...
  exports.For = For = (function (_super) {
    ...
    function For(body, source) {
      ...
      this.range =
        this.source instanceof Value &&
        this.source.base instanceof Range &&
    ...
    For.prototype.compileNode = function (o) {
      ...
      lastJumps =
        (_ref2 = last(body.expressions)) != null ? _ref2.jumps() : void 0;
      ...
      if (this.range) {
        ...
        if (!this.object) {
          ...
          forVarPart =
            "" + kvarAssign + ivar + " = 0, " + lvar + " = " + svar + ".length";
          if (this.step) {
            forVarPart +=
              ", " + stepvar + " = " + this.step.compile(o, LEVEL_OP);
          }
          stepPart =
            "" +
            kvarAssign +
      ...
      if (this.pattern) {
        body.expressions.unshift(
          new Assign(this.name, new Literal("" + svar + "[" + kvar + "]"))
        );
      }
        ...
        if (
          !(
            ...
            (val instanceof Value &&
              ((_ref3 = val.base) != null
                ? _ref3.unwrapAll()
                : void 0) instanceof Code &&
              val.properties.length === 1 &&
              ((_ref4 =
                (_ref5 = val.properties[0].name) != null
                  ? _ref5.value
                  : void 0) === "call" ||
                _ref4 === "apply"))
          )
  ...
  exports.Switch = Switch = (function (_super) {
    ...
    Switch.prototype.compileNode = function (o) {
      ...
      for (i = _i = 0, _len = _ref3.length; _i < _len; i = ++_i) {
        ...
        if (
          expr instanceof Return ||
          (expr instanceof Literal && expr.jumps() && expr.value !== "debugger")
        ) {
          continue;
        }
        code += idt2 + "break;\n";
  ...
  exports.If = If = (function (_super) {
    ...
    function If(condition, body, options) {
      ...
      this.condition =
        options.type === "unless" ? condition.invert() : condition;
      this.elseBody = null;
      this.isChain = false;
    ...
    If.prototype.jumps = function (o) {
      ...
      return (
        this.body.jumps(o) ||
        ((_ref2 = this.elseBody) != null ? _ref2.jumps(o) : void 0)
      );
    };
    ...
    If.prototype.compileStatement = function (o) {
      ...
      return (
        ...
        (this.isChain
          ? ((o.indent = this.tab),
            (o.chainChild = true),
            this.elseBody.unwrap().compile(o, LEVEL_TOP))
    ...
    If.prototype.compileExpression = function (o) {
      ...
      alt = this.elseBodyNode()
        ? this.elseBodyNode().compile(o, LEVEL_LIST)
        : "void 0";
      code = "" + cond + " ? " + body + " : " + alt;
      if (o.level >= LEVEL_COND) {
        return "(" + code + ")";
  ...
  Closure = {
    ...
    literalArgs: function (node) {
      return (
        node instanceof Literal && node.value === "arguments" && !node.asKey
      );
    },
...
define("ace/mode/coffee/scope", [
  ...
  exports.Scope = Scope = (function () {
    ...
    Scope.prototype.check = function (name) {
      ...
      return !!(
        this.type(name) ||
        ((_ref1 = this.parent) != null ? _ref1.check(name) : void 0)
      );
    };
