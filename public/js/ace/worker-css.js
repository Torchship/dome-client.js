...
define("ace/mode/css/csslint", ["require", "exports", "module"], function (
  require,
  exports,
  module
) {
    ...
    var ValidationTypes = {
      ...
      simple: {
        ...
        "<bg-image>": function (part) {
          return (
            this["<image>"](part) || this["<gradient>"](part) || part == "none"
          );
        },
  ...
  CSSLint.addRule({
    ...
    init: function (parser, reporter) {
      ...
      parser.addListener("property", function (event) {
        if (
          /\-(moz|ms|o|webkit)(?:\-(?:linear|radial))\-gradient/i.test(
            event.value
          )
        ) {
